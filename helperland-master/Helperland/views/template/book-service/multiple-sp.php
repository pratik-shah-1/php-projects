...
<body>
    <div style="padding:10px 15px;border-radius:4px;border:0.5px solid lightgray;">
        <p style="padding:8px 0; text-align:center; font-size:14px;font-weight:bold;color:#4f4f4f">Customer Book a Cleaning Service in your area, you can accept a service based on your interest.</p>
        <!-- CUSTOMER INFO -->
