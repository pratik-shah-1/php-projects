...
<body>
    <div style="padding:40px 15px 10px;border-radius:4px;border:0.5px solid lightgray;">
        <p style='font-size:20px; text-align:center; font-weight:bold;color:#1D7A8C'>Welcome to Helperland!</p>
        <br>
        <p style="padding:4px 0;text-align:center;font-size:14px;font-weight:bold;color:#4f4f4f">Your Account has been created successfully.</p>
        <br>
        <p style="padding:4px 0;font-size:12px;color:#4f4f4f">You must follow this link for verify your account</p>
