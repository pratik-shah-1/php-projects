...
<body>
    <div style="padding:10px 15px;border-radius:4px;border:0.5px solid lightgray;">
        <p style="padding:8px 0; text-align:center; font-size:14px;font-weight:bold;color:#4f4f4f">Your rescheduled service request has been sent. (Request reschedule by Admin)</p>
